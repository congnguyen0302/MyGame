    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        public void NeverDie()
        {
            if (Input.GetKeyDown(KeyCode.H))
            {
                ...
                hpPlayer.slider.value = hpPlayer.hpStart;
                ChangeState(IdleState);
            }
        }
        ...
        public void InstantiateSkill1()
        {
            ...
            bullet.velocity.x = right.x * bulletController.speedBullet;
       ...
       /* private void SaveJsonData()
        {
            ...
            data.damage = attackDamage;
            data.lv = expPlayer.level;
            data.expCurrent = expPlayer.currentExp;
            data.expMax = expPlayer.expMax;
            data.hpCurrent = hpPlayer.hpCurrent;
            data.coin = GetCoin.Coin.getCoin;
        ...
        private DataPlayer LoadJsonData(string json)
        {
            var dataObject = JsonUtility.FromJson<DataPlayer>(json);
            return dataObject;
        } */
    }
